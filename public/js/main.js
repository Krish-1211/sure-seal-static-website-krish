!(function (t) {
    ...
    if (
        ...
        t(".vertical-counter").length > 0 &&
            t(document).on("appear", ".vertical-counter", function (e) {
                t(window).scrollTop() + z() >=
                    t(".vertical-counter").offset().top &&
                    t(this)
        ...
        t(".countdown").each(function () {
            var e = t(this);
            e.countdown(e.attr("data-enddate")).on(
                "update.countdown",
                function (t) {
                    e.html(
                        t.strftime(
        ...
        document
            ...
            .forEach(function (e, a) {
                var o =
                        "IGQVJXTm1iQkFKNHlTNlNuTG9lcnltRVM2dG9XTC05Wnc4aEtMTFVpVzNOQkFVWExGbXNLTTlNWjZAwUXA3WUFjSzBsbWRsQXExS0o1ZA2JPdndDUFlFWUdMSkhrVmNkX1RDYjhZAT29yRzh2UXAxeTNqVgZDZD",
                    i = t(e),
                    n =
                        ((o = i.attr("data-token") || o),
                        i.attr("data-total") || "6"),
                            ...
                            a.data))
                                if (
                                    ...
                                    var d = a.data[o].permalink || "",
                                        ...
                                        g = s;
                                    (g = (g = (g = (g = (g = (g = (g = (g =
                                        g.replace(' href="#"', "")).replace(
                                        ' src="#"',
                                        ""
                                    )).replace("data-href", "href")).replace(
                                        "data-src",
                                        "src"
                                    )).replace("{{link}}", d)).replace(
                                        "{{image}}",
                                        p
                                    )).replace("{{likes}}", u)).replace(
                                        "{{comments}}",
                                        m
                                    )),
                                        (l += g);
    ...
    if (t(".portfolio-colorful").length > 0)
        for (
            var m = t(".portfolio-colorful").find(".grid-item").length,
                g =
                    t(".portfolio-colorful").attr("data-backgroundcolor") ||
                    "#2e94eb",
    ...
    t(".lightbox-group-gallery-item").each(function () {
        ...
        t(document).on("click", ".submit", function () {
            ...
            return (
                l.length > 0 &&
                    (l.is(":checked") || ((e = !0), l.addClass("error"))),
                "undefined" != typeof grecaptcha &&
                    ...
                    (i.find(".g-recaptcha").length > 0
                        ...
                        : "" != s &&
                          ...
                          i
                              .find(
                                  "input[name=action],input[name=g-recaptcha-response]"
                              )
                              .remove(),
    ...
    t(document).on("touchstart click", "body", function (e) {
        t(e.target).closest(".navbar-nav").length
            ? t(e.target).parents(".show-menu").length
                ? t(".close-menu").trigger("click")
                : t(e.target).parents("body").find(".header-language.open")
                      .length
                ...
                if (t("body").hasClass("navbar-collapse-show"))
                    t(".navbar-modern-inner").length > 0 &&
                        ...
                        t(".navbar-full-screen-menu-inner").length > 0 &&
                            setTimeout(function () {
                                t(".navbar-full-screen-menu-inner").css(
                                    "background",
                                    ""
                                );
                            }, 600);
                ...
                t(this)
                    ...
                    .each(function () {
                        ...
                        e
                            .parent()
                            .find(".menu-toggle")
                            .attr("data-bs-target") != a && e.collapse("hide");
                    }),
                    t(".left-sidebar-wrapper .left-sidebar-nav")
                        .parents("body")
                        .addClass("left-classic-mobile-menu"),
                        ...
                        (i.on.slideChange = function () {
                            t(".swiper-pagination-current").length > 0 &&
                                ...
                                t(".swiper-pagination-total").length > 0 &&
                                    t(".swiper-pagination-total").html(
                                        j(this.slides.length - 2)
                                    );
                        });
    ...
    function U() {
        ...
        (!t(".navbar").hasClass("top-space") &&
            ...
            t(".mobileoff-fullscreen-top-space").length >= 0 &&
                N() > 1023 &&
                t(".mobileoff-fullscreen-top-space").css(
                    "height",
                    z() - e + "px"
                ),
    ...
    function F() {
        ...
        N() <= i
            ...
            e.parents("section").imagesLoaded(function () {
                t("section:first.full-screen, section:first .full-screen")
                    .length > 0 &&
                (t(".top-space").length > 0 ||
                    t(".mobile-top-space").length > 0)
                    ? t(
                    ...
                    ? ((a -= t("header nav.navbar").outerHeight()),
                      e.css("height", a))
                    : e.css("height", a);
            });
    }
                                ...
                                var a =
                                    ...
                                    (e.offset().left +
                                        e
                                            ...
                                            .outerWidth());
                                a < 0 &&
                                    e.children(".dropdown-menu").css("left", a);
                            }
                            if (
